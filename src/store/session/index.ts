...
import { InitStateSession, SessionStateConfig, UserData } from "./types";

/**
 * Сессия
 */

class SessionState extends StoreModule<SessionStateConfig, InitStateSession> {
  /**
   * Начальное состояние
   * @return {Object}
   */
  initState(): InitStateSession {
    return {
      user: {},
      token: null,
      errors: null,
   ...
   */
  async signIn(data: UserData, onSuccess: any) {
